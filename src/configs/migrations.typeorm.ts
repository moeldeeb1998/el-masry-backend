...
import { AddRefreshTokenColumnToUsersTable1712605777964 } from '../migrations/1712605777964-AddRefreshTokenColumnToUsersTable';

export const migrations = [
  CreateUsersTable1712452797152,
  AddColumnsToUsersTable1712453853244,
  CreateTestsTable1712489190141,
  AddRefreshTokenColumnToUsersTable1712605777964,
];
